...
public class Library {
    ...
    private static final ArrayList<Playable> defaultPlayables = new ArrayList<>();
    ...
    //Getter for list of defaultPlayables
    public static ArrayList<Playable> getDefaultPlayables() {
        if (defaultPlayables.size() == 0) {
            System.out.println("No playables have been specified as defaults.");
        }
        return defaultPlayables;
    }
    //Adds a playable object to the defaultPlayables list
    public void addDefaultPlayable(Playable pPlayable) {
        defaultPlayables.add(pPlayable);
    }

    //Removes all defaultPlayables
    public static void resetDefaultPlayables() {
        defaultPlayables.clear();
    }
}
